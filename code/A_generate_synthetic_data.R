...
# Their invented labels (fast and slow metabolisers) support the final reveal.
...
# The `metaboliser` column records the labels used to generate the data. We
# deliberately ignore it until the final plot. Real plots cannot identify an
# unmeasured biological mechanism on their own.
#
...
# --- Placebo: one population, unremarkable ----------------------------------
placebo <- data.frame(
...
# --- Caffeine: two populations hiding inside one group ----------------------
